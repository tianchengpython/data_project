...
class DataTiramisu():
    ...
    #         是否将文件
            ...
            if if_all:
                ...
                data_list = [i for i in doc.paragraphs][start_num:end_num]
                for i in data_list:
...
if __name__ == '__main__':
    ...
    # 提取pdf文件中的数据：
    # data_dict = {
    #     "read_file_pdf":"./data_files/pdf/",   #读取文件路径
    #     "new_pdf_file_path":"./data_files/pdf/",  #读取单个pdf才使用到
    ...
    #     "if_all":True #True读取文件夹中所有数据，False读取单个
    # }
...
#     提取word中的数据：
#     dat_dict = {
#         "read_file_word":"./data_files/word/",   #读取文件路径
#         "save_file_word":"./txts/save_word_txt/word.txt", #存放word提取出来的数据
#         "start_num":0, #单个word使用：开始
#         "end_num":100,#单个word使用：结束
#         "if_all":True #True读取文件夹中所有数据，False读取单个
#     }
